...
<div style={{fontSize:"24px",fontFamily:"Bebas Neue, sans-serif",letterSpacing:"2px"}}>{packTotal}£ <span style={{fontSize:"11px",color:isActive?"rgba(255,255,255,0.5)":"rgba(0,0,0,0.4)"}}>-{pack.discount}%</span></div>
                              {activeDraw.totalTickets ? <div style={{fontSize:"11px",letterSpacing:"1px",marginTop:"5px",color:isActive?"rgba(255,255,255,0.75)":"rgba(0,0,0,0.55)",fontFamily:"'DM Sans',sans-serif",fontWeight:"600"}}>{(lang==="en"?"1 in ":lang==="es"?"1 posibilidad entre ":"1 chance sur ")+Math.round(activeDraw.totalTickets/pack.qty)}</div> : null}</button>                          );
                        })}
                      </div>
