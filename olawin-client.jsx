...
<button className="nav-link" onClick={function(){ goTo("parrainage"); }} style={{textAlign:"left",fontSize:"14px",padding:"8px 0"}}>{lang==="en"?"REFERRAL":lang==="es"?"PADRINAZGO":"PARRAINAGE"}</button>
          <button className="nav-link" onClick={function(){ goTo("influenceur"); }} style={{textAlign:"left",fontSize:"14px",padding:"8px 0"}}>{lang==="en"?"INFLUENCER":lang==="es"?"INFLUENCER":"INFLUENCEUR"}</button>          <button className="nav-link" onClick={function(){ goTo("faq"); }} style={{textAlign:"left",fontSize:"14px",padding:"8px 0"}}>{t.nav.faq}</button>
