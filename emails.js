...
export async function sendAdminNotification({
  ...
  const html = '<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"></head><body style="margin:0;padding:0;background:#f5f2ed;font-family:Helvetica Neue,Arial,sans-serif;">' +
    ...
    '<a href="' + SITE_URL + '/admin" style="display:block;background:#1a1a1a;color:#f0ede7;text-decoration:none;padding:14px;border-radius:10px;font-size:12px;font-weight:700;letter-spacing:2px;text-align:center;">VOIR DANS L\'ADMIN</a>' +
    '</td></tr>' +
